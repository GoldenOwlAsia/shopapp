...
export const GET_RECENT_ORDERS = `${ORDER_PREFIX}GET_RECENT_ORDERS`;
export const GET_RECENT_ORDERS_SUCCESS = `${ORDER_PREFIX}GET_RECENT_ORDERS_SUCCESS`;
export const GET_RECENT_ORDERS_FAIL = `${ORDER_PREFIX}GET_RECENT_ORDERS_FAIL`;
